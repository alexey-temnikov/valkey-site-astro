...
cards:
  - icon: "icon-bulb.svg"
    title: "Workshop"
    description: "If you're joining us for 'Introduction to Valkey + Python' you can find the materials and platform by clicking 'Workshop Platform' below."
    links:
      - url: "/try-valkey/pyconafrica-workshop/"
        text: "Workshop Platform"
---
