...
handle: adamfowler
name: Adam Fowler
bio: Adam is an open source programmer who thinks Swift should be used for more than
  iPhone apps. He is a member of the SSWG (Swift server working group) and maintains
  a number of libraries in the Swift on
image: /assets/media/authors/adamfowler.png
github: adam-fowler
---
