...
slug: go-client-in-public-preview
pubDate: '2025-03-04'
description: Valkey Glide now supports GO. Read to learn more about the new client
  designed for performance and developer productivity
authors:
- niharikabhavaraju
heroImage: /assets/media/featured/default.webp
types:
- Announcements
---
