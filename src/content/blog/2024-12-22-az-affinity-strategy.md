---
title: Reducing application latency and lowering Cloud bill by setting up your client
  library
slug: az-affinity-strategy
pubDate: '2025-01-08'
description: By implementing AZ affinity routing in Valkey and using GLIDE, you can
  achieve lower latency and cost savings by routing requests to replicas in the same
  AZ as the client.
authors:
- asafporatstoler
- adarovadya
