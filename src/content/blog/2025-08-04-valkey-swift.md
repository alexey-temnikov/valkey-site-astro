...
slug: valkey-swift
pubDate: '2025-08-04'
description: The new Swift client for Valkey is now in preview. Learn about its features
  and how it brings the performance of Valkey to the Swift language.
authors:
- adamfowler
featured: true
...
![An image that shows non-pipelined commands waiting for each response, and pipelined commands that send a burst of commands, a technique which shows the advantage of pipelining by submitting sets of commands quickly.](/assets/blog/valkey-swift/images/valkey-pipelining.png)
