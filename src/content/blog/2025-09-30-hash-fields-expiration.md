...
slug: hash-fields-expiration
pubDate: '2025-09-30'
description: "One of Valkey’s greatest strengths has always been its built-in ability\
  \ to expire keys.\n    This simple but powerful feature helps developers keep datasets\
  \ fresh, automatically clear caches, and enforce session lifetimes — all without\
  \ extra application logic.\n    But until now, expiration worked only at the level\
  \ of entire keys.  \n    In this post, we’ll explore how Valkey 9.0 introduces per-field\
  \ expiration for hash objects, \n    the challenges we faced designing it, the tradeoffs\
  \ we considered, and the benchmarks that guided our final implementation.  \n  \
  \  We’ll also walk through practical examples to show how you can start using this\
  \ feature today."
authors:
- ranshid
featured: true
heroImage: /assets/media/featured/random-08.webp
types:
- Technical Deep Dive
---
...
![Diagram illustrating optional solution using a secondary hashtable index](/assets/blog/hash-fields-expiration/hfe-alternative-hashtable.png)
...
![Diagram illustrating optional solution using a secondary radix-tree index](/assets/blog/hash-fields-expiration/hfe-alternative-radixtree.png)
...
![Diagram illustrating optional solution using a secondary skiplist index](/assets/blog/hash-fields-expiration/hfe-alternative-skiplist.png)
...
![Diagram illustrating our selected coarse buckets solution](/assets/blog/hash-fields-expiration/hfe-coarse-buckets.png)
...
![Chart indicating the per field memory overhead for different hash object encoding types](/assets/blog/hash-fields-expiration/hfe-benchmark-memory.png)
...
![Chart comparing the throughput of common hash commands both with and without field expirations](/assets/blog/hash-fields-expiration/hfe-benchmark-hash-commands.png)
...
![Chart showing the throughput of the new expiration-aware commands](/assets/blog/hash-fields-expiration/hfe-benchmark-new-commands.png)
...
![Chart showing the time it took the expiration cron job complete the full deletion of all the 10M fields](/assets/blog/hash-fields-expiration/hfe-benchmark-reclaim-time.png)
...
![Chart presenting the ability of active expiration job to reclaim memory during constant data ingestion](/assets/blog/hash-fields-expiration/hfe-benchmark-active-expiry.png)
...
Using Valkey’s [HSETEX](/commands/hsetex) and [HGETEX](/assets/blog/hash-fields-expiration/(/commands/hgetex)), we can update a field’s TTL whenever it’s accessed or modified:
