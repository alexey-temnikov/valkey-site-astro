...
slug: numbered-databases
pubDate: '2025-09-25'
description: Valkey 9.0 brings new namespacing abilities to cluster mode. In this
  blog you'll learn about numbered databases, how they've changed in the recent release,
  limitations, and how you can use them to efficiently solve a variety of otherwise
  challenging problems.
authors:
- kyledvs
featured: true
heroImage: /blog/numbered-databases/images/move-db.drawio.png
types:
- Technical Deep Dive
---
...
![one key, many databases](/assets/blog/numbered-databases/images/numbered-db.drawio.png)
...
![now you see me, now you don't](/assets/blog/numbered-databases/images/move-db.drawio.png)
...
![show me it when its done](/assets/blog/numbered-databases/images/zadd-move.drawio.png)
