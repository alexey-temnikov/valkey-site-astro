...
![dict structure](/assets/blog/new-hash-table/dict-structure.png)
...
![hashtable structure](/assets/blog/new-hash-table/hashtable-structure.png)
...
![hashtable structure](/assets/blog/new-hash-table/hashtable-child-buckets.png)
...
![bucket structure](/assets/blog/new-hash-table/hash-bucket-structure.png)
...
![memory usage by version](/assets/blog/new-hash-table/memory-usage.png)
...
![memory usage with expire](/assets/blog/new-hash-table/memory-usage-with-expire.png)
