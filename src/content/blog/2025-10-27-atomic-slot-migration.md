...
slug: atomic-slot-migration
pubDate: '2025-10-29'
description: Valkey 9.0 brings big changes and improvements to the underlying mechanisms
  of resharding. Find out how Atomic Slot Migration works, the benefits it brings,
  and the headaches it eliminates.
authors:
- murphyjacob4
featured: true
heroImage: /assets/media/featured/random-05.webp
types:
- Technical Deep Dive
---
...
![Diagram showing how how atomic slot migration is broken into the three phases](/assets/blog/atomic-slot-migration/atomic-slot-migration-phases.png)
...
![Chart showing time to scale in and out when under load, from the table below](/assets/blog/atomic-slot-migration/legacy-vs-atomic-latency.png)
...
![Picture of the following formula rendered in LaTeX: RTTs = SlotsCount * (3 * KeysPerSlot/KeysPerBatch + 4) = 4096 * (3 * 160/10 + 4) = 212992](/assets/blog/atomic-slot-migration/legacy-rtt-formula.png)
...
![Chart showing queries per second over time. Atomic slot migration quickly dips and recovers, while legacy slot migration incurs a sustained dip](/assets/blog/atomic-slot-migration/legacy-vs-atomic-client-impact.png)
...
![Diagram showing how Valkey uses CLUSTER SYNCSLOTS to drive atomic slot migration](/assets/blog/atomic-slot-migration/atomic-slot-migration-syncslots.png)
