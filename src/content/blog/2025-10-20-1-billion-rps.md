...
slug: 1-billion-rps
pubDate: '2025-10-20'
description: Learn about the internal workings of cluster mode and the improvements
  which helped to scale to 1 Billion RPS with the latest Valkey 9.0 release
authors:
- hpatro
- maheshcherukumilli
- sarthakaggarwal97
- sungming2
featured: true
heroImage: /assets/media/featured/random-04.webp
types:
- Technical Deep Dive
---
...
![Diagram showcasing different operational mode](/assets/blog/1-billion-rps/1B-rps-overview.png)
...
![Diagram showcasing membership discovery and mesh topology formation](/assets/blog/1-billion-rps/1B-rps-node-discovery.png)
...
![Diagram showcasing failure detection and failover](/assets/blog/1-billion-rps/1B-rps-failover.png)
...
![Diagram showcasing 1 billion request per sec throughput](/assets/blog/1-billion-rps/1B-rps-throughput.png)
...
![Diagram showcasing recovery time across various primary failure scenarios](/assets/blog/1-billion-rps/1B-rps-recovery-time.png)
