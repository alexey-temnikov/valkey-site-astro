...
slug: valkey-helm-chart
pubDate: '2026-01-06'
description: A guide on why the new Valkey Helm chart exists, how it helps, and how
  to migrate from Bitnami.
authors:
- sgissi
- maheshcherukumilli
featured: true
heroImage: /assets/media/featured/valkey-helm.webp
types:
- Announcements
---
