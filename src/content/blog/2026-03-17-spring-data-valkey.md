...
slug: spring-data-valkey
pubDate: '2026-04-01'
description: Introducing Spring Data Valkey, a new open source Spring Data module
  that provides first-class integration between Valkey and the Spring ecosystem.
authors:
- makubo-aws
- ikolomi
types:
...
![RPS Scalability – Total Workload Throughput](/assets/blog/spring-data-valkey/images/throughput-rps-scalability.png)
...
![Latency p99.9 – GET Command](/assets/blog/spring-data-valkey/images/latency-p99-get-commands.png)
